...
const getProductId = () => {
  ...
  const selectedColor = document.querySelector("#colors");// Better use  getElementById 
  ...
  let registeredProduct = (product) => {
    ...
    button.addEventListener("click", (event) => {
      ...
      if (selectedColor.value == false) {
        ...
        let selectedProduct = {
          id: product._id,
          // name: product.name, don't keep it because it is already used in back end 
          img: product.imageUrl,
          // altTxt: product.altTxt,  don't keep it because it is already used in back end 
          // description: product.description,  don't keep it because it is already used in back end 
